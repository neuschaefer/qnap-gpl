...
#define METADATA_BLOCK_SIZE 8192ULL
#define NUM_BACKUP_METADATA_BLOCKS 128ULL
...
#define LV_NOT_THIN_POOL_METADATA	0
#define LV_IS_THIN_POOL_METADATA	1
...
int set_lv(struct cmd_context *cmd, struct logical_volume *lv,
	   uint64_t offset, uint64_t sectors, int value, int is_thin_metadata);
