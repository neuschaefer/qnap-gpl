...
Source0:       http://www.sibbald.com/apcupsd/%{name}-%{version}.tar.gz
...
%files usb
%defattr(-,root,root)
%doc COPYING ChangeLog doc/README.* doc/developers_manual examples ../Release_Notes-%{version}-%{release}.txt
%dir /etc/apcupsd
%dir /etc/apcupsd/cgi
%{initdir}/apcupsd
