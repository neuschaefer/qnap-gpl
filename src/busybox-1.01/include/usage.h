...
#define df_trivial_usage \
	"[-" USAGE_HUMAN_READABLE("hm") USAGE_NOT_HUMAN_READABLE("") "kc] [FILESYSTEM ...]"
...
#define passwd_full_usage \
	...
	"\t-g GECOS\tChange user gecos.(format: fullname,email,description,reserve)\n" \
...
#define ping_full_usage \
	...
	"\t\t\tand when finished." \
	"\t-w TIMEOUT\tSet gethostbyname timeout.\n"
#endif
