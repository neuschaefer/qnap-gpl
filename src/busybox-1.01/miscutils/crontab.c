...
#define CRONTABS	"/tmp/cron/crontabs"	//Add by Kent@QNAP 2011/01/25
#endif
#ifndef TMPDIR
//#define TMPDIR          "/var/spool/cron"
#define TMPDIR		"/tmp/cron"	//Add by Kent@QNAP 2011/01/25
#endif
#ifndef CRONUPDATE
...
ChangeUser(const char *user, short dochdir)
{
    ...
    if (dochdir) {
//	if (chdir(pas->pw_dir) < 0) {	//Modify by Kent@QNAP 2011/02/10
