/*
 * "$Id: job.c,v 1.3 2013/10/29 07:17:15 aixchou Exp $"
 *
...
cupsdContinueJob(cupsd_job_t *job)	/* I - Job */
{
  ...
  */
  ...
  if (
#ifndef QNAPNAS
	(!job->printer->raw && job->compressions[job->current_file]) 
#else
	(job->compressions[job->current_file])
#endif
	||
...
/*
 * End of "$Id: job.c,v 1.3 2013/10/29 07:17:15 aixchou Exp $".
 */
