...
/* Here follows boolean settings that define how to behave during
  ...
  bool bFTPQuoteOnly;
  // jeff modify 2010.7.27, force to not change dir, we record working dir in qsync to not change dir   
  // in every file task which is at the same dir to speed up  
  bool bFTPNotChdir;
  ...
  PT_PARSER_OBJECT  ptParserCmd;
  PT_PARSER_OBJECT  ptParserData;
  // jeff modify 2010.10.7, for calculating data translation lag time out
  PT_PARSER_OBJECT  ptTransLagTime;
  // jeff modify 2010.8.23, for qsync progress statistic
  uint64_t *pcbUploadByte;
  uint64_t *pcbDownloadByte;
  // jeff modify 2010.9.1, for net speed
  struct timeval *ptvTransTime;
