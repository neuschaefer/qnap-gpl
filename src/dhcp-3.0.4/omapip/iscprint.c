...
/* $Id: iscprint.c,v 1.1.1.1 2008/01/15 08:14:51 jimmychang Exp $ */
...
"$Id: iscprint.c,v 1.1.1.1 2008/01/15 08:14:51 jimmychang Exp $ Copyright (c) 2004 Internet Systems Consortium, Inc.  All rights reserved.";
#endif
