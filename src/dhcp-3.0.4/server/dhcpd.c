...
"$Id: dhcpd.c,v 1.1.1.1 2008/01/15 08:14:51 jimmychang Exp $ Copyright 2004-2006 Internet Systems Consortium.";
#endif
...
// Tiger
#define         DHCP_LEASE_TMP          "/var/state/dhcp/dhcpd.leases.tmp"
// end
