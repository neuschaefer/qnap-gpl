...
extern errcode_t ext2fs_read_inode_large(ext2_filsys fs, ext2_ino_t ino, struct ext2_inode_large* inode);
extern errcode_t ext2fs_write_inode_large(ext2_filsys fs, ext2_ino_t ino, struct ext2_inode_large *inode);
extern errcode_t ext2fs_write_new_inode_large(ext2_filsys fs, ext2_ino_t ino, struct ext2_inode_large *inode);
