...
int main (int argc, char ** argv)
{
	 ...
	 */
	//[S] Benjamin 20110516: skip for test 
	#if 1
	if ((fs->super->s_feature_incompat & EXT4_FEATURE_INCOMPAT_FLEX_BG) &&
    	...
    	#endif
	//[E] Benjamin 20110516: skip for test 
...
#define _SC_PAGESIZE _SC_PAGE_SIZE
	...
	if (force_min_size)
	    ...
	    // [S] Benjamin 20110510: sync from e2fsprogs-1.41.14
		/* Take down devices exactly 16T to 2^32-1 blocks */
		if (max_size == (1ULL << 32))
			max_size--;
        /*  // Marked by Benjamin due to we should support > 16TB
		...
		*/
        // [E] Benjamin 20110510: sync from e2fsprogs-1.41.14
		new_size = max_size;
