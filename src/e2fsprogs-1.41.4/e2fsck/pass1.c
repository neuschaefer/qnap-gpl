...
#if 0
			/*
			 * Patched by QNAP, FIXME
			 * Bug#118988
			 * Although the dir_index feature is not enabled by
			 * default on the freshly created file system, the case
			 * insensitive patch hacks this feature and turns on
			 * the EXT2_INDEX_FL flags.  Once the bit is wiped out,
			 * we could not create more than EXT4_LINK_MAX
			 * sub-directories.
			 */
			inode->i_flags &= ~EXT2_INDEX_FL;
			dirty_inode++;
