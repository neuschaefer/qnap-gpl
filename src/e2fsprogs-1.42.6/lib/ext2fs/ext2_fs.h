...
#define EXT2_GROUPS_TO_BLOCKS(s, g)		((blk64_t) EXT2_BLOCKS_PER_GROUP(s) * (g))
#define EXT2_GROUPS_TO_CLUSTERS(s, g)	((blk64_t) EXT2_CLUSTERS_PER_GROUP(s) * (g))
...
#else
	__u32	s_checksum;		/* crc32c(superblock) */
	__u32   s_hash_magic;           /* HTREE use case insensitive*/
#endif
#else
