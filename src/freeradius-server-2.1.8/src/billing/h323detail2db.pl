...
#
# $Id: h323detail2db.pl,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $
#
...
sub main {
	...
	if ($opt_V) {
		...
		my $rcs_info = 'CVS Revision $Revision: 1.1.1.1 $ created on $Date: 2010/03/11 07:11:43 $ by $Author: richardchang $ ';
