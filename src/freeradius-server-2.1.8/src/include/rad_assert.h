 ...
 *
 * Version:	$Id: rad_assert.h,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $
 *
...
RCSIDH(rad_assert_h, "$Id: rad_assert.h,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $")
