 ...
 *
 * Version:	$Id: radclient.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $
 *
...
RCSID("$Id: radclient.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $")
...
int main(int argc, char **argv)
{
	...
	while ((c = getopt(argc, argv, "46c:d:f:Fhi:n:p:qr:sS:t:vx")) != EOF) switch(c) {
		...
		case 't':
			...
			break;
		case 'v':
			printf("radclient: $Id: radclient.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $ built on " __DATE__ " at " __TIME__ "\n");
			exit(0);
			break;
		case 'x':
			fr_debug_flag++;
