 ...
 * rlm_attr_rewrite.c
 *
 * Version:  $Id: rlm_attr_rewrite.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $
 *
...
RCSID("$Id: rlm_attr_rewrite.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $")
