 ...
 *
 * Version:     $Id: rlm_dbm_cat.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $
 *
...
int main(int n, char **argv) {
	...
	while ((ch = getopt(n, argv, "i:l:wf:v")) != -1)
		switch (ch) {
			...
			case 'f':	fname = optarg;
					break;
			case 'v':	printf("%s: $Id: rlm_dbm_cat.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $\n",progname);
					exit(0);
					break;
