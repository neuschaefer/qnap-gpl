 ...
 *
 * Version:     $Id: rlm_dbm_parser.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $
 *
...
char sccsid[] =
"$Id: rlm_dbm_parser.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $ sandy module project\n Copyright 2001 Sandy Service\nCopyright 2001 Koulik Andrei";
	...
	while ((ch = getopt(n, argv, "d:i:xo:qvc")) != -1)
	 	switch (ch) {
			...
			case 'q':
				...
				break;
			case 'v':
				printf("%s: $Id: rlm_dbm_parser.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $ \n",progname);
				exit(0);
			case 'c':
