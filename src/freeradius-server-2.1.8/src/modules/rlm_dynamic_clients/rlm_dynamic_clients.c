 ...
 *
 * Version:	$Id: rlm_dynamic_clients.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $
 *
...
RCSID("$Id: rlm_dynamic_clients.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $")
