 ...
 *
 * Version:	$Id: radeapclient.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $
 *
...
RCSID("$Id: radeapclient.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $")
...
int main(int argc, char **argv)
{
	...
	while ((c = getopt(argc, argv, "c:d:f:hi:qst:r:S:xXv")) != EOF)
	{
		...
		case 't':
			...
			break;
		case 'v':
			printf("radclient: $Id: radeapclient.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $ built on " __DATE__ " at " __TIME__ "\n");
			exit(0);
			break;
               case 'S':
		       fp = fopen(optarg, "r");
