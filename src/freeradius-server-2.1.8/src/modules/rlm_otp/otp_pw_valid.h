/*
 * $Id: otp_pw_valid.h,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $
 *
...
RCSIDH(otp_pw_valid_h, "$Id: otp_pw_valid.h,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $")
