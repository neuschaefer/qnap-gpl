 ...
 *
 * Version:	$Id: rlm_pam.c,v 1.2 2011/03/09 04:50:47 ken Exp $
 *
...
RCSID("$Id: rlm_pam.c,v 1.2 2011/03/09 04:50:47 ken Exp $")
...
//KenChen@QNAP
#if !defined(HAVE_SECURITY_PAM_APPL_H) && !defined(HAVE_PAM_PAM_APPL_H) && defined(QNAP)
#include	<security/pam_appl.h>
#endif
