 ...
 *
 * Version:	$Id: rlm_sqlhpwippool.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $
 *
...
static const char rcsid[] = "$Id: rlm_sqlhpwippool.c,v 1.1.1.1 2010/03/11 07:11:43 richardchang Exp $";
