...
#include "apr_network_io.h"		// Include this to enable QNAP service binding. (Added by clko, 2011/05/17.)
...
static int worker_run(apr_pool_t *_pconf, apr_pool_t *plog, server_rec *s)
{
    ...
    //ap_log_error(APLOG_MARK, APLOG_NOTICE, 0, ap_server_conf, "[ServBind] Get_Binding_Address: %d, %d, %d, %d", iRetDbg, g_tbaDaemon.bEnabled, g_tbaDaemon.cnIpv4, g_tbaDaemon.cnIpv6);
#endif /* QNAP_SERVICE_BINDING */
