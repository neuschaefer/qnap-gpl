...
#define QNAP_SERVICE_BINDING	// Define this to enable QNAP service binding. (Added by clko, 2011/05/17.)
...
// Defines a error code to represent rejecting a connection from the unbound interface.
// Note: This value MUST NOT be the same with any error code defined in NasX86/NasMgmt/HTTP/httpd-2.2.14/srclib/apr/include/apr_error.h.
#define E_UNBOUND_INTERFACE		7000
...
extern T_BIND_ADDR  g_tbaDaemon;
extern int g_qLisan;
