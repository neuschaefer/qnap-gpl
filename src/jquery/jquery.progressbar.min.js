...
text.html('<span style="white-space: nowrap;">'+config.pretext+" "+Math.round(cpercentage)+"%</span>");if(cpercentage>tpercentage){if(cpercentage-increment<tpercentage){pb.config.cpercentage=0+tpercentage}else{pb.config.cpercentage-=increment;}}
