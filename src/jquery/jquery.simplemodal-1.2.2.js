 ...
 * Revision: $Id: jquery.simplemodal-1.2.2.js,v 1.3 2013/04/26 06:41:02 henrylu Exp $
 */
...
(function ($) {
	...
	$.modal.defaults = {
		...
		closeTooltip: 'IEI_NAS_BUTTON_CLOSE',
	...
	$.modal.impl = {
		...
		create: function () {
			...
			this.dialog.container = $('<div/>')
				...
				.append(this.opts.close 
					? typeof eval('IEI_NAS_BUTTON_NO') == 'undefined' ? $(this.opts.closeHTML).addClass(this.opts.closeClass) : $(this.opts.closeHTML).addClass(this.opts.closeClass).attr('title', eval(this.opts.closeTooltip))
					: '')
				.appendTo('body');
		...
		open: function () {
			...
			var e = this;
			setTimeout(function () {
				e.dialog.container.css({zIndex:e.opts.zIndex + 2});
			}, 500 );
		},
		/*
