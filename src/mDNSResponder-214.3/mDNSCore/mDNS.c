...
$Log: mDNS.c,v $
Revision 1.3  2011/02/18 12:13:45  ken
fix

Revision 1.2  2011-02-18 12:06:02  ken
fix sen goodbye msg

Revision 1.1.1.1  2009-11-20 23:00:08  charley
...
mDNSexport void mDNS_StartExit(mDNS *const m)
	...
	SendResponses(m); //Fix: send goodbye/unregister message, KenChen@QNAP
	mDNS_Unlock(m);
