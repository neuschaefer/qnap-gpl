/*
 * $Id: configfile.c,v 1.2 2011/11/10 12:27:41 ken Exp $
...
//patched by QNAP, username must be admin
	if((strcmp(ws_uri(pwsc),"/index.html") == 0) && (!username || strcasecmp(username,"admin") != 0)) {
        DPRINTF(E_LOG,L_MISC,"Auth: Only admin can pass here! \n");
        return FALSE;
    }
//end here	
