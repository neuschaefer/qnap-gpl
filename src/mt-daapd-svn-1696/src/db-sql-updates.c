/*
 * $Id: db-sql-updates.c,v 1.1.1.1 2011/11/03 12:26:52 ken Exp $
...
#ifdef QNAPNAS
    "update songs set description='' where type='m4a';\n"
    "update songs set description='' where type='mp3';\n"
    "update songs set description='' where type='wav';\n"
    "update songs set description='' where type='pls';\n"
    "update songs set description='' where type='ogg';\n"
    "update songs set description='' where type='flac';\n"
    "update songs set description='' where type='mpc';\n"
#else
