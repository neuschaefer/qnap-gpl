/*
 * $Id: mp3-scanner.c,v 1.2 2013/06/19 11:02:31 dennistien Exp $
...
#ifdef QNAPNAS // don't add description for new version iTures which always show descriptions
    { "aac", scan_get_aacinfo, "m4a", "mp4a", 0, "" },
    { "mp4", scan_get_aacinfo, "m4a", "mp4a", 0, "" },
    { "m4b", scan_get_aacinfo, "m4a", "mp4a", 0, "" },
    { "m4a", scan_get_aacinfo, "m4a", "mp4a", 0, "" },
    { "m4p", scan_get_aacinfo, "m4p", "mp4a", 0, "" },
    { "mp3", scan_get_mp3info, "mp3", "mpeg", 0, "" },
    { "wav", scan_get_wavinfo, "wav", "wav", 0, "" },
    { "aif", scan_get_aifinfo, "aif", "aif", 0, "" },
    { "aiff",scan_get_aifinfo, "aif", "aif", 0, "" },
    { "wma", scan_get_wmainfo, "wma", "wma", 0, "" },
    { "url", scan_get_urlinfo, "pls", NULL, 0, "" },
    { "pls", scan_get_urlinfo, "pls", NULL, 0, "" },
    { "m4v", scan_get_aacinfo, "m4v", "mp4v", 1, "" },
    { "mp4", scan_get_aacinfo, "m4v", "mp4v", 1, "" },
    { "mov", scan_get_aacinfo, "m4v", "mp4v", 1, "" },
    { "mpeg4", scan_get_aacinfo, "m4v", "mp4v", 1, "" },
#ifdef OGGVORBIS
    { "ogg", scan_get_ogginfo, "ogg", "ogg", 0, "" },
#endif
#ifdef FLAC
    { "flac", scan_get_flacinfo, "flac","flac", 0, "" },
    { "fla", scan_get_flacinfo,  "flac","flac", 0, "" },
#endif
#ifdef MUSEPACK
    { "mpc", scan_get_mpcinfo, "mpc", "mpc", 0, "" },
    { "mpp", scan_get_mpcinfo, "mpc", "mpc", 0, "" },
    { "mp+", scan_get_mpcinfo, "mpc", "mpc", 0, "" },
#endif
...
int scan_path(char *path) {
    ...
    char *exclude_dir;
    char *dir;
    exclude_dir = conf_alloc_string("general","exclude_dir","@Recycle,.@__thumb");
#endif //QNAPNAS
...
#ifdef QNAPNAS
	if (strcasestr(exclude_dir, pde->d_name)) {
	    continue;
	}
#endif //QNAPNAS
