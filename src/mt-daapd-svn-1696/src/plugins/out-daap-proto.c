/*
 * $Id: out-daap-proto.c,v 1.1.1.1 2011/11/03 12:26:52 ken Exp $
 */
...
//==== patched @QNAP on 2011/Oct/31 ===
        if(daap_wantsmeta(pinfo->meta, metaItunesMediaKind))
            // FIX for iTunes 10; 1 = Music
            current += dmap_add_char(current,"aeMK", (char)0x1);
//===  ===
