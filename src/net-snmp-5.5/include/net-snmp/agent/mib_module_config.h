...
/* Define if compiling with the qnapNAS module files.  */
#define USING_QNAPNAS_MODULE 1
 
/* Define if compiling with the mibII/entityMIB module files.  */
#define USING_MIBII_ENTITYMIB_MODULE 1
 
/* Define if compiling with the default_modules module files.  */
#define USING_DEFAULT_MODULES_MODULE 1
 
/* Define if compiling with the qnapNAS/SystemInfo module files.  */
#define USING_QNAPNAS_SYSTEMINFO_MODULE 1
 
/* Define if compiling with the qnapNAS/storage module files.  */
#define USING_QNAPNAS_STORAGE_MODULE 1
 
/* Define if compiling with the qnapNAS/SystemInfoEx module files.  */
#define USING_QNAPNAS_SYSTEMINFOEX_MODULE 1
 
/* Define if compiling with the qnapNAS/storageEx module files.  */
#define USING_QNAPNAS_STORAGEEX_MODULE 1
 
/* Define if compiling with the qnapNAS/common module files.  */
#define USING_QNAPNAS_COMMON_MODULE 1
 
/* Define if compiling with the qnapNAS/Volume module files.  */
#define USING_QNAPNAS_VOLUME_MODULE 1
 
/* Define if compiling with the qnapNAS/Pool module files.  */
#define USING_QNAPNAS_POOL_MODULE 1
 
/* Define if compiling with the qnapNAS/Raid module files.  */
#define USING_QNAPNAS_RAID_MODULE 1
 
/* Define if compiling with the qnapNAS/Cpu module files.  */
#define USING_QNAPNAS_CPU_MODULE 1
 
/* Define if compiling with the qnapNAS/Systemfan module files.  */
#define USING_QNAPNAS_SYSTEMFAN_MODULE 1
 
/* Define if compiling with the qnapNAS/Systempower module files.  */
#define USING_QNAPNAS_SYSTEMPOWER_MODULE 1
 
/* Define if compiling with the qnapNAS/Enclosure module files.  */
#define USING_QNAPNAS_ENCLOSURE_MODULE 1
 
/* Define if compiling with the qnapNAS/Disk module files.  */
#define USING_QNAPNAS_DISK_MODULE 1
 
/* Define if compiling with the qnapNAS/Msatadisk module files.  */
#define USING_QNAPNAS_MSATADISK_MODULE 1
 
/* Define if compiling with the qnapNAS/Diskperformance module files.  */
#define USING_QNAPNAS_DISKPERFORMANCE_MODULE 1
 
/* Define if compiling with the qnapNAS/Iscsistorage module files.  */
#define USING_QNAPNAS_ISCSISTORAGE_MODULE 1
 
/* Define if compiling with the qnapNAS/Iscsitarget module files.  */
#define USING_QNAPNAS_ISCSITARGET_MODULE 1
 
/* Define if compiling with the qnapNAS/Iscsilun module files.  */
#define USING_QNAPNAS_ISCSILUN_MODULE 1
 
/* Define if compiling with the qnapNAS/Cacheacceleration module files.  */
#define USING_QNAPNAS_CACHEACCELERATION_MODULE 1
