...
#define SCSI_ATTR_BUF_LEN	128

extern int __iscsi_sysfs_get_dev_vendor(
	char *value, int host_no, int target, int lun);

extern int __iscsi_sysfs_get_dev_model(
	char *value, int host_no, int target, int lun);

extern int __iscsi_sysfs_get_dev_naa(
	char *value, int host_no, int target, int lun);

extern int __iscsi_sysfs_get_probe_sd_done(
	int *value, int host_no, int target, int lun);

extern int __iscsi_sysfs_get_probe_sd_type(
	int *value, int host_no, int target, int lun);

extern int __iscsi_sysfs_set_probe_sd_type(
	char *buf, int host_no, int target, int lun);

extern int __iscsi_sysfs_set_probe_sd(
	void *data, int host_no, int target, int lun);

extern int __iscsi_sysfs_set_remove_sd(
	void *data, int host_no, int target, int lun);

extern int __iscsi_sysfs_get_dev_state(
	char *buf, int host_no, int target, int lun);

extern int __iscsi_sysfs_get_dev_size_info(
	char *buf, int host_no, int target, int lun);

extern int __iscsi_sysfs_get_dev_sd_name(
	char *buf, int host_no, int target, int lun);

extern int __iscsi_sysfs_get_dev_sn(
	char *buf, int host_no, int target, int lun);
