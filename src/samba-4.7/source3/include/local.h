...
#ifdef QNAPNAS
/* Maximum length is 19, use 24 for safety.
 * Format like:
 * 14-chars for Server name, 2-chars for PR, 2-chars for digital number,
 * and 1-char for null-terminated. */
#define MAXPRINTERLEN 24
#else /* QNAPNAS */
...
#ifdef QNAPNAS
#define SMB_ROUNDUP_ALLOCATION_SIZE 0x1000
#else /* QNAPNAS */
