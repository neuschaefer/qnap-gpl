...
#if defined(QNAPNAS_LINUXFALLOCATE) && defined(HAVE_LIBLINUXFALLOCATE) && defined(QNAPNAS_MARVELL_6281)
	return syscall(__NR_fallocate, fd, 0,
		       __LONG_LONG_PAIR ((long int) (offset >> 32),
					 (long int) offset),
		       __LONG_LONG_PAIR ((long int) (len >> 32),
					 (long int) len));
#elif defined(QNAPNAS_LINUXFALLOCATE) && defined(HAVE_LIBLINUXFALLOCATE)
	return syscall(__NR_fallocate, fd, 0, offset, len);
#else
	return posix_fallocate(fd, offset, len);
#endif /* QNAPNAS_LINUXFALLOCATE && HAVE_LIBLINUXFALLOCATE && QNAPNAS_MARVELL_6281 */
...
#if defined(QNAPNAS_LINUXFALLOCATE) && defined(HAVE_LIBLINUXFALLOCATE) && defined(QNAPNAS_MARVELL_6281)
	return syscall(__NR_fallocate, fd, lmode,
		       __LONG_LONG_PAIR ((long int) (offset >> 32),
					 (long int) offset),
		       __LONG_LONG_PAIR ((long int) (len >> 32),
					 (long int) len));
#elif defined(QNAPNAS_LINUXFALLOCATE) && defined(HAVE_LIBLINUXFALLOCATE)
	return syscall(__NR_fallocate, fd, lmode, offset, len);
#else
