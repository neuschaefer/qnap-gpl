...
static enum remote_extended_arch_types era_type = ERA_UNKNOWN;
#endif /* QNAPNAS */
...
#ifdef QNAPNAS
/* for File Station remote mount */
void set_remote_extended_arch(enum remote_extended_arch_types type)
{
	era_type = type;
}

enum remote_extended_arch_types get_remote_extended_arch(void)
{
	return era_type;
}
#endif /* QNAPNAS */
