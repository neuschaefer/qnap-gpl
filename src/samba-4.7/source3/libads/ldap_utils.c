...
#ifdef QNAPNAS
static ADS_STATUS ads_do_search_retry_internal_q(ADS_STRUCT **adsp, const char *bind_path, int scope,
                                               const char *expr,
                                               const char **attrs, void *args,
                                               LDAPMessage **res)
{
 ...
 ADS_STATUS ads_do_search_retry_q(ADS_STRUCT **ads, const char *bind_path,
                                int scope, const char *expr,
                                const char **attrs, LDAPMessage **res)
{
        return ads_do_search_retry_internal_q(ads, bind_path, scope, expr, attrs, NULL, res);
}
#endif
