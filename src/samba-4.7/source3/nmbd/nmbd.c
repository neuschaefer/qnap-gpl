				     ...
				     DATA_BLOB *data)
{
	 ...
	 * 
	 * KS-Redmine#28226
	 * Reannounce server string when reloading nmbd service
	 */
	if (register_my_workgroup_and_names() == False)
		DEBUG(10, ("msg_reload_nmbd_services: Failed to register_my_workgroup_and_names\n"));			
#endif /* QNAPNAS */
}
