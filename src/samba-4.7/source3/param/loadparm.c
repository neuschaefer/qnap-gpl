...
static const struct loadparm_service _sDefault =
{
	...
	.admin_only = NULL,
	.encryption = false,
	.ftp_write_only = false,
	.indexing = NULL,
	.ignore_share_perm = false,
	.qbox = false,
	.recycle_bin = false,
	.recycle_bin_administrators_only = false,
	.usb_users = NULL,
	.q_use_receivefile = true,
	.vol_size_limit = 0,
	.aio_read_check_offset = true,
	.aio_read_size_on_sequential = 0,
	.only_admin_change_posixacl = false,
#endif /* QNAPNAS */
...
#ifdef QNAPNAS
	Globals.ntlm_auth = NTLM_AUTH_ON;	/* Do NOT use NTLMv1 if it is supplied by the client (otherwise NTLMv2) */
#else
...
#ifdef QNAPNAS
	Globals.announce_as = ANNOUNCE_AS_NT_WORKSTATION;
	Globals.conn_log = false;

	Globals.enhance_acl_v1 = false;
	Globals.remove_everyone = false;

	Globals.usb_interface = NULL;
	Globals.use_interfaces_policy = false;
#endif /* QNAPNAS */
