...
#if ! defined(QNAPNAS)
			/* Bug#63602, disable UPN login support now. If group name
			 * including at-sign, we don't know this at-sign is a UPN
			 * token or not. So we disable the UPN parsing temporary.
			 * */
