...
void load_dns_interface_list(TALLOC_CTX *mem_ctx, struct loadparm_context *lp_ctx, struct interface **local_interfaces)
{
        const char **ptr = lpcfg_dns_interfaces(lp_ctx);
        int i;
