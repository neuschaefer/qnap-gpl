...
#   if __WORDSIZE == 64
      typedef unsigned long int uintptr_t;
#   else
#ifdef QNAPNAS_MARVELL_6281
/*
 * uintptr_t is declared here:
 * /opt/cross-project/arm/marvell/arm-none-linux-gnueabi/libc/marvell-f/usr/include/stdint.h
 */
#else /* QNAPNAS_MARVELL_6281 */
      typedef unsigned int uintptr_t;
#endif /* QNAPNAS_MARVELL_6281 */
#   endif /* __WORDSIZE == 64 */
#  else /* __WORDSIZE */
