...
[ -d "${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-2.0.9" ] || ./install-sh -d "${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-2.0.9"
./install-sh -o root -g root -m 0644 doc/reference/syslog-ng.html.tar.gz \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-2.0.9/syslog-ng.html.tar.gz
./install-sh -o root -g root -m 0644 doc/reference/syslog-ng.txt \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-2.0.9/syslog-ng.txt
./install-sh -o root -g root -m 0644 ChangeLog \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-2.0.9/ChangeLog
./install-sh -o root -g root -m 0644 NEWS \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-2.0.9/NEWS
./install-sh -o root -g root -m 0644 README \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-2.0.9/README
./install-sh -o root -g root -m 0644 AUTHORS \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-2.0.9/AUTHORS
./install-sh -o root -g root -m 0644 COPYING \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-2.0.9/COPYING
...
%{prefix}/bin/loggen
%{_mandir}/*
%docdir %{_prefix}/share/doc/syslog-ng-2.0.9
%{_prefix}/share/doc/syslog-ng-2.0.9/*
