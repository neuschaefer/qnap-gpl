...
static const unsigned mappings_per_block(void)
{
	...
	} btree_size = { DEFAULT_BLOCK_SIZE, 64, 16 };
...
static void print_estimated_result(struct global *g)
{
	...
	r = (1.0 + (2 * g->options.n[POOLSIZE] / g->options.n[BLOCKSIZE] / mappings_per_block() + g->options.n[MAXTHINS])); /* in 4k/8k blocks */
	r *=  DEFAULT_BLOCK_SIZE; /* in bytes! */
