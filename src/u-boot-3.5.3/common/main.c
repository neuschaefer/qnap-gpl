...
#include <command.h>
#ifdef QNAPNAS
/* Richard Chen 20081219, QNAP for Recovery Button */
#include <qnap.h>
#endif /* QNAPNAS */
...
#ifdef QNAPNAS
/* Richard Chen 20081217, QNAP for Recovery Button ****/
static uint32_t recovery_button = 0;
#endif /* QNAPNAS */
...
#ifdef QNAPNAS
    /* Richard Chen 20081218, QNAP for recovery button */
...
#ifdef QNAPNAS
    /* Richard Chen 20081217 Add for reset button */
    if(abort) {
        printf("QNAP: Recovery Button pressed: %u\n", recovery_button);
    }
#endif /* QNAPNAS */
#ifdef CONFIG_SILENT_CONSOLE
	{
...
#ifdef QNAPNAS
    /* Richard Chen 20081218, 
     * QNAP initiate the recovery facility */    
    if(recovery_button >= 500) {
        int rc;
        printf("Do Recovery ..\n");
