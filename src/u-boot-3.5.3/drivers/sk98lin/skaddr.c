...
static const char SysKonnectFileId[] =
	"@(#) $Id: skaddr.c,v 1.1.1.1 2010/10/18 09:56:07 roylin Exp $ (C) Marvell.";
	...
	case SK_INIT_IO:
...

				{
					...
					if ((strcmp(boardName,"DB-88F5181-DDR1-PRPMC") == 0) ||
					   ...
					   (strcmp(boardName,"DB-88F5X81-DDR1-MNG") == 0) ||
						(strcmp(boardName,"DB-88F6183L-BP") == 0) ||
					   (strcmp(boardName,"RD-MV78X00-H3C") == 0) ||
