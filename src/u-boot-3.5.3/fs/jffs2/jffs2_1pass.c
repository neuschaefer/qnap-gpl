...
-------------------------------------------------------------------------
 * Filename:      jffs2.c
 * Version:       $Id: jffs2_1pass.c,v 1.1.1.1 2010/10/18 09:56:07 roylin Exp $
 ...
 *
 * $Id: jffs2_1pass.c,v 1.1.1.1 2010/10/18 09:56:07 roylin Exp $
 *
 */
		...
		if ((inode == jNode->ino)) {
			...
			if(dest) {
                ...
                case JFFS2_COMPR_NONE:
					...
					ret = (unsigned long) memcpyFlash(lDest, src, jNode->dsize);
#else
