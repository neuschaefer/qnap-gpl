...
/* $Id: tunelp.c,v 1.1.1.1 2008/01/17 10:51:58 ricky Exp $
 * $Log: tunelp.c,v $
 * Revision 1.1.1.1  2008/01/17 10:51:58  ricky
 * Sys Utility
 *
 * Revision 1.1.1.1  2006/10/17 06:37:11  root
 * NasARM init
 *
 * Revision 1.1.1.1  2005/09/15 09:31:24  ricky
 * util-linux-2.12q
 *
